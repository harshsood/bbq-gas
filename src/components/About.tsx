...
import gasCylinder from "../images/girl-with-shopping-carriage-walks-across-bridge-before-skyscrapers.jpg";
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Why Choose BBQ Gas for Your Cylinder Needs?
            </h2>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Dubai Municipality Licensed</h3>
                  <p className="text-gray-600">Fully licensed gas cylinder supplier with all necessary certifications for safe handling, storage, and delivery across Dubai.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Our certified technicians follow international safety standards and conduct thorough cylinder inspections with every delivery and installation.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Consistent, on-time gas cylinder delivery with 24/7 customer support and emergency refill services across all Dubai areas.</p>
                </div>
              </div>
            </div>
